...
<html lang="en" class="h-100">
	<head>
		...
		<title>Royal Event Bookings - Halls</title>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="d-main-title">
							<h3><i class="fa-solid fa-user-group me-3"></i>All Halls</h3>
						</div>
					</div>
					<div class="col-md-12">
												...
												<table class="table">
													...
													<tbody>
														<tr>															
															...
															<td><?= $rows['capacity'];?> persons</td>
															<td><?= $rows['modified_at'];?></td>
															<td><a href="edit-hall.php?id= <?= $rows['id'];?>" class="action-btn"><i class="fa-solid fa-pen"></i></a></td>						
														</tr>														
														<?php
															}
														?>														
