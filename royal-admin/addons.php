...
<html lang="en" class="h-100">
	<head>
		...
		<title>Royal Event Bookings - Addons</title>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="addCategoryModalLabel">Addon</h5>
                    ...
                    <div class="modal-body">
                        <div class="model-content main-form">
                            ...
                            <div class="form-group mt-30">
                                ...
                                <input class="form-control h_40" type="text" name="addon" required="required">
                            </div>                            
                            <div class="form-group mt-30">
                                <label class="form-label">Price</label>
                                <input class="form-control h_40" type="number" name="price" placeholder="Enter Price" required>
                            </div>											
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="co-main-btn min-width btn-hover h_40" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" name="add_addon" class="main-btn min-width btn-hover h_40">Save</button>
                    </div>
                </form>
			</div>
		</div>
                            ...
                            <div class="d-md-flex flex-wrap align-items-center">
                                <div class="nav custom2-tabs btn-group" role="tablist">
                                    <div class="d-main-title">
                                        <h3><i class="fa-solid fa-plus me-3"></i>All Addons</h3>
                                    </div>
                                </div>
                                <div class="rs ms-auto mt_r4">
                                    <button class="main-btn btn-hover h_40 w-100" data-bs-toggle="modal" data-bs-target="#addCategoryModal"><i class="fa-solid fa-plus me-3"></i>Add New</button>
                                </div>
                            </div>
                        </div>
                    </div>
												...
												<table class="table">
													...
													<tbody>
														<tr>															
															<td><?= $rows['name'];?></td>										
															<td><?= $rows['price'];?></td>															                                                          
															<td><a href="delete-addon.php?id=<?= $rows['id'];?>"><i class="fa-solid fa-trash-can me-3"></i></a></td>						
														</tr>														
														<?php
															}
														?>														
