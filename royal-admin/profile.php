...
<html lang="en" class="h-100">
	<head>
		...
		<title>Royal Event Bookings - Profile</title>
										...
										<div class="row">
											...
											<div class="col-lg-6 col-md-12">
												<div class="form-group mt-4">
													...
													<input class="form-control h_40" type="text" name="username" value="<?= $rows['username'];?>">
													<input type="" name="id" hidden value="<?= $rows['id'];?>">					
												</div>
											</div>
											<div class="col-lg-6 col-md-12">
												<div class="form-group mt-4">
													<label class="form-label">Password*</label>
													<input class="form-control h_40" type="text" name="password" value="<?= $rows['password'];?>">
												</div>
											</div>
											<?php
													}
											...
											<div class="col-lg-6 col-md-12">
												<div class="form-group mt-4">
													...
													<button type="submit" name="edit_admin" class="main-btn min-width btn-hover h_40">Edit</button>
												</div>
											</div>
										</div>
									</form>									
