				...
				<div class="row">
					<div class="col-md-12">
						<div class="d-main-title">
							<h3><i class="fa-solid fa-user-group me-3"></i>All Bookings</h3>
						</div>
					</div>
					<div class="col-md-12">
										...
										<div class="main-table">
											<div class="table-responsive">
												<table class="table">
													...
													<tbody>
														<tr>
															<td><a href="view-booking.php?id= <?= $rows['id'];?>" class="action-btn"><i class="fa-solid fa-eye"></i></a></td>	
															<td><?= $rows['id'];?></td>										
															<td><?= $rows['fullname'];?></td>
															<td><?= $rows['email'];?></td>	
															<td><?= $rows['event_name'];?></td>
															<td><?= $rows['event_day'];?></td>
															<td><?= $rows['category'];?></td>
															<td><?= $rows['date'];?></td>
															<td><a href="edit-booking.php?id= <?= $rows['id'];?>" class="action-btn"><i class="fa-solid fa-pen"></i></a></td>						
														</tr>														
														<?php
															}
														?>														
