...
<html lang="en" class="h-100">
	<head>
		...
		<title>Royal Event Bookings - Event Category</title>
                            ...
                            <div class="d-md-flex flex-wrap align-items-center">
                                <div class="nav custom2-tabs btn-group" role="tablist">
                                    <div class="d-main-title">
                                        <h3><i class="fa-solid fa-spinner me-3"></i>All Event Category</h3>
                                    </div>
                                </div>
                                <div class="rs ms-auto mt_r4">
                                    <button class="main-btn btn-hover h_40 w-100" data-bs-toggle="modal" data-bs-target="#addCategoryModal">Add Event Category</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                                                ...
                                                                <div class="d-flex align-items-center">											
                                                                    <div class="dropdown dropdown-default dropdown-text dropdown-icon-item">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            <a href="edit-event-category.php?id=<?= $rows['id'];?>" class="dropdown-item"><i class="fa-solid fa-pen me-3"></i>Edit</a>
                                                                            <a href="delete-event-category.php?id=<?= $rows['id'];?>" class="dropdown-item"><i class="fa-solid fa-trash-can me-3"></i>Delete</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </td>						
