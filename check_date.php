...
if(isset($_POST['check']))
{
	...
	{
		$_SESSION['picked_date'] = $date;
		header("Location:adjust-time.php");
	}
	else
	{
		$_SESSION['picked_date'] = $date;		
			...
			<div class="row justify-content-center">
				<div class="col-lg-12 col-md-12">
					<div class="main-title text-center checkout-title">
						<h3>Date Checker</h3>
						<h6>When does your event start? </h6>
						<p class="mt-2 fs-14 d-block mb-3">Let's check to see if there's a free spot for your event to hold</p>
					</div>
					<div class="row">
					<?php
						if(count($errors) == 1){
							...
							<div class="col-md-12">
								<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
									<div class="form-group border_bottom ">
										<div class="row">
											<div class="col-md-4">
												<label class="form-label mt-3 fs-6">Start Date.*</label>																
												<div class="loc-group position-relative">
													<input class="form-control datepicker-here" data-language="en" required name="date" type="text" placeholder="YYYY/MM/DD" value="">
									...
									<div class="step-footer step-tab-pager mt-4">
										<button name="check" type="submit" class="btn btn-default btn-hover steps_btn">Check Date</button>
